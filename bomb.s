...
0000000000400da0 <main>:
  ...
  400e14:	e8 07 fe ff ff       	callq  400c20
...
0000000000400efc <phase_2>:
  ...
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax            ## Loop
...
0000000000400f43 <phase_3>:
  ...
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)         ## Switch buf[2]
...
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp              ## | Settup
  400fd2:	89 d0                	mov    %edx,%eax              ## |
  400fd4:	29 f0                	sub    %esi,%eax              ## | int buf[ ]
  400fd6:	89 c1                	mov    %eax,%ecx              ## | int a = z - y
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx             ## |
  400fdb:	01 c8                	add    %ecx,%eax              ## | a = a + (a >> 31), logical (%rax)
  400fdd:	d1 f8                	sar    %eax                   ## | a >>= 1, arithmetic
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx     ## | int b = a + y (%rcx)
  400fe2:	39 f9                	cmp    %edi,%ecx              ##
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>    ## if (b <= x) { goto L1 }
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx        ## z = b - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>         ## a = func4(x, y, z)
  400fee:	01 c0                	add    %eax,%eax              ## a = a + a
  400ff0:	eb 15                	jmp    401007 <func4+0x39>    ## goto END
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax              ## L1, a = 0
  400ff7:	39 f9                	cmp    %edi,%ecx              ## if (b > x)
  400ff9:	7d 0c                	jge    401007 <func4+0x39>    ## { goto DONE }
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi         ##
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>         ## a = func4(x, b + 1, z)
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  ## a = 2 * a + 1
  401007:	48 83 c4 08          	add    $0x8,%rsp              ## END
  40100b:	c3                   	retq                          ## return a
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx                         ##
  401063:	48 83 ec 20          	sub    $0x20,%rsp                   ## buf[ ], (%rsp)
  401067:	48 89 fb             	mov    %rdi,%rbx                    ##
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                ## int a = th, (%rax)
  401071:	00 00
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)              ## buf[6] = a
  401078:	31 c0                	xor    %eax,%eax                    ## a = a ^ a = 0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>       ## int len = strlen*=(input), (%rax)
  40107f:	83 f8 06             	cmp    $0x6,%eax                    ## if (len == 6)
  401082:	74 4e                	je     4010d2 <phase_5+0x70>        ## { goto L1 }
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>        ## explode_bomb()
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>        ## goto L1
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx           ## L2, b = input[a], (%rcx)
  40108f:	88 0c 24             	mov    %cl,(%rsp)                   ## buf[0] = b
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                  ## int c = buf[0] & 0xF, (%rdx)
  401096:	83 e2 0f             	and    $0xf,%edx                    ## -----
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx          ## c = (c + 0x4024b0), line 33 in .rodata
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)        ## buf[a + 4] = LSB-of c
  4010a4:	48 83 c0 01          	add    $0x1,%rax                    ## a = a + 1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                    ## if (a != 6)
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>        ## { goto L2 }
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)              ## buf[22?(bytes)] = 0
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi               ## a = strings_not_equal(rsp[4?], 0x40245e)
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi              ##
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>   ##
  4010c2:	85 c0                	test   %eax,%eax                    ## if (a == 0)
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>        ## { goto L3 }
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>        ## explode_bomb()
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)             ##
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>        ## goto L3
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                    ## L1, a = 0, (%rax)
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>        ## goto L2
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax              ## L3, a = buf[6]
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax                ## if (a != th) {
  4010e5:	00 00                                                     ## {
  4010e7:	74 05                	je     4010ee <phase_5+0x8c>        ##    some_stack_error()
  4010e9:	e8 42 fa ff ff       	callq  400b30 <__stack_chk_fail@plt>## }
  4010ee:	48 83 c4 20          	add    $0x20,%rsp                   ##
  4010f2:	5b                   	pop    %rbx                         ## END
  4010f3:	c3                   	retq
...
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp                         ## |
  4010fb:	53                   	push   %rbx                         ## |
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp                   ## aux[ ], (%rsp)
  401100:	49 89 e5             	mov    %rsp,%r13                    ## a = aux, (%r13)
  401103:	48 89 e6             	mov    %rsp,%rsi                    ## g = aux, (%rsi)
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>    ## read_six_numbers(input, g)


  40110b:	49 89 e6             	mov    %rsp,%r14                    ## b = aux, (%r14)
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                   ## c = 0, (%r12)


  401114:	4c 89 ed             	mov    %r13,%rbp                    ## L3: d = a, (%rbp)
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax               ## e = a[0], (%rax)
  40111b:	83 e8 01             	sub    $0x1,%eax                    ## e = e - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax                    ## if (e > 5) {
  401121:	76 05                	jbe    401128 <phase_6+0x34>        ##   explode_bomb()
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>        ## }

  401128:	41 83 c4 01          	add    $0x1,%r12d                   ## c = c + 1

  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                   ## if (c == 6)
  401130:	74 21                	je     401153 <phase_6+0x5f>        ## { goto L1 }
  401132:	44 89 e3             	mov    %r12d,%ebx                   ## f = c, (%rbx)
  401135:	48 63 c3             	movslq %ebx,%rax                    ## L2: (long, signed) e = f, (%rax)
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           ## e = aux[e]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)               ## if (e == *d) {
  40113e:	75 05                	jne    401145 <phase_6+0x51>        ##   explode_bomb()
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>        ## }

  401145:	83 c3 01             	add    $0x1,%ebx                    ## f = f + 1
  401148:	83 fb 05             	cmp    $0x5,%ebx                    ## if (f <= 5)
  40114b:	7e e8                	jle    401135 <phase_6+0x41>        ## { goto L2 }
  40114d:	49 83 c5 04          	add    $0x4,%r13                    ## a = a + 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>        ## goto L3



  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              ## L1: g = aux + 24
  401158:	4c 89 f0             	mov    %r14,%rax                    ## e = b
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    ## h = 7, (%rcx)
  401160:	89 ca                	mov    %ecx,%edx                    ## L4: i = h, (%rdx)
  401162:	2b 10                	sub    (%rax),%edx                  ## i = i - *e
  401164:	89 10                	mov    %edx,(%rax)                  ## *e = i
  401166:	48 83 c0 04          	add    $0x4,%rax                    ## e = e + 1 (4 bytes, 1 elem)
  40116a:	48 39 f0             	cmp    %rsi,%rax                    ## if (g != e)
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>        ## { goto L4 }
  ...
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx               ## L7: i = *(i + 8)
  40117a:	83 c0 01             	add    $0x1,%eax                    ## e = e + 1
  40117d:	39 c8                	cmp    %ecx,%eax                    ## if (h != e)
  40117f:	75 f5                	jne    401176 <phase_6+0x82>        ## { goto L7 }

  401181:	eb 05                	jmp    401188 <phase_6+0x94>        ## goto L8
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx               ## L6: i = some_pointer
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       ## L8: aux[g * 2 + 32] = i (in bytes)
  40118d:	48 83 c6 04          	add    $0x4,%rsi                    ## g = g + 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                   ## if (g == 24)
  401195:	74 14                	je     4011ab <phase_6+0xb7>        ## { goto L9 }

  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           ## L5: h = aux[g]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    ## if (h <= 1)
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>        ## { goto L6 }
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                    ## e = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx               ## i = some_pointer
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>        ## goto L7



  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx              ## L9: f = aux[32] (bytes)
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax              ## e = aux + 40 (bytes)
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi              ## g = aux + 80 (bytes)
  4011ba:	48 89 d9             	mov    %rbx,%rcx                    ## h = f
  4011bd:	48 8b 10             	mov    (%rax),%rdx                  ## L11: i = *e
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)               ## *(h + 8) = i (bytes)
  4011c4:	48 83 c0 08          	add    $0x8,%rax                    ## e = e + 8 (bytes)
  4011c8:	48 39 f0             	cmp    %rsi,%rax                    ## if (e == g)
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>        ## { goto L10 }
  4011cd:	48 89 d1             	mov    %rdx,%rcx                    ## h = i
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>        ## goto L11



  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)               ## L10: *(i + 8) = 0
  4011d9:	00                                                        ##
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                    ## d = 5

  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax               ## L12: e = *(f + 8) (bytes)
  4011e3:	8b 00                	mov    (%rax),%eax                  ## e = *e
  4011e5:	39 03                	cmp    %eax,(%rbx)                  ## if (*f < e) {
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>        ##   explode_bomb()
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>        ## }
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx               ## f = *(f + 8) (bytes)
  4011f2:	83 ed 01             	sub    $0x1,%ebp                    ## d = d - 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>        ## if (d != 0) { goto L12 }
